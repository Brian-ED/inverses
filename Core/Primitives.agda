...
module _ where
  ...
  +invʳ {error plus (function args stmt) L.∷ v₂ L.∷ fst , snd} = refl
  ...
  +invʳ {function args stmt L.∷ v₂ L.∷ fst , snd} = refl
  ...
  +invˡ {error plus (function args stmt) L.∷ v₂ L.∷ fst , snd} = refl
  ...
  +invˡ {function args stmt L.∷ v L.∷ fst , snd} = refl
